...
function RemainingVideoPlayer({ video }) {
    return (
        <Link to={`/videoDetails/${video.videoId}`} className="flex p-2 gap-2 hover:bg-gray-700 rounded-md transition">
            {/* Video Thumbnail */}
            ...
            <div className="text-white">
                ...
                <h2 className="text-gray-400 text-xs">{video.uploader}</h2>
